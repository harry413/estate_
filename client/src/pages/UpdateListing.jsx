...
const UpdateListing = () => {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3xl font-semibold text-center mt-2 my-7'>Update a listing</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4 flex-1'>
          ...
          <div className='flex flex-col flex-1 gap-4'>
            ...
            <button disabled={loading || uploading} className='p-3 bg-slate-700 border text-white uppercase hover:opacity-95 disable:opacity-80 rounded-lg'>{loading ? 'Updating.....' : 'update Listing'}</button>
